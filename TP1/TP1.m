...
Tplane = manimate(plane, Pplane, Tplane, mrotz(linspace(0,-theta,NN)), 0);
...
for n=1:(NN*5)-1
    ...
    elseif (NN*10/4 < n) && (n < NN*15/4)
        TcurrPpir = manimate(pir, Ppir, TcurrPpir, mrotz(tpir(3,2)), 0);
    elseif (NN*15/4 < n)
    ...
    elseif (NN*2 < n) && (n < NN*3)
        TcurrPp = manimate(p, Pp, TcurrPp, mrotz(t(3,2)), 0);
        TcurrPt1 = manimate(t1, Pt1, TcurrPt1, mrotz(t(3,2)), 0);
        TcurrPt2 = manimate(t2, Pt2, TcurrPt2, mrotz(tt2(1,2)), 0);
        TcurrPtb1 = manimate(tb1, Ptb1, TcurrPtb1, mrotz(t(3,2)), 0);
        TcurrPtb2 = manimate(tb2, Ptb2, TcurrPtb2, mrotz(ttb2(1,2)), 0);
        TcurrPtm1 = manimate(tm1, Ptm1, TcurrPtm1, mrotz(ttm1(1,2)), 0);
    elseif (NN*3 < n) && (n < NN*4)
